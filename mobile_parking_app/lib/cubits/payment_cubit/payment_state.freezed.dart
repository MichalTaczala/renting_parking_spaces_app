...
mixin _$PaymentState {
  String? get isok => throw _privateConstructorUsedError;
...
class _$PaymentStateImpl implements _PaymentState {
  const _$PaymentStateImpl({this.isok});
...
abstract class _PaymentState implements PaymentState {
  const factory _PaymentState({final String? isok}) = _$PaymentStateImpl;
